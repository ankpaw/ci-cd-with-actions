[![React App CI](https://github.com/ankpaw/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/ankpaw/ci-cd-with-actions/actions/workflows/ci.yml)
